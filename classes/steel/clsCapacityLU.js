...
import {ArrayMin,rtd,dtr,I1,I2,tan_inv,sin,cos} from '@/library/mathLib'

export default class CapacityLU extends Steel {
    constructor({ method, Fy, shape, Lu, Lx, Ly,Kx = 1, Ky = 1}) {
        super({ method, Fy })
        this.LU = DataLU.find(item => item.Shape == shape)
        this.c = 1
        this.cb = 1
        this.Lu = Lu*12
        this.Lx = Lx*12
    ...
    bw(){
        switch(true){
            case (this.LU.Shape.startsWith('L8X6')):
                return 3.31
            case (this.LU.Shape.startsWith('L8X4')):
                return 5.48
            case (this.LU.Shape.startsWith('L7X4')):
                return 4.37
            case (this.LU.Shape.startsWith('L6X4')):
                return 3.14
            case (this.LU.Shape.startsWith('L6X3-1/2')):
                return 3.69
            case (this.LU.Shape.startsWith('L5X3-1/2')):
                return 2.4
            case (this.LU.Shape.startsWith('L5X3')):
                return 2.99
            case (this.LU.Shape.startsWith('L4X3-1/2')):
                return 0.87
            case (this.LU.Shape.startsWith('L4X3')):
                return 1.65
            case (this.LU.Shape.startsWith('L3-1/2X3')):
                return 0.87
            case (this.LU.Shape.startsWith('L3-1/2X2-1/2')):
                return 1.62
            case (this.LU.Shape.startsWith('L3X2-1/2')):
                return 0.86
            case (this.LU.Shape.startsWith('L3X2')):
                return 1.56
            case (this.LU.Shape.startsWith('L2-1/2X2')):
                return 0.85
        }
