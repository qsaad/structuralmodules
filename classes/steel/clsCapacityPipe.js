...
export default class CapacityPipe extends Steel {
    ...
    //-----------------------------------------------------------
	WallFlexure(){
		return this.P.D_T < 0.07*this.E/this.Fy ? "Compact": (this.P.D_T < 0.31*this.E/this.Fy ? "Non-Compact": "Slender") ;
	}//WallFlexure
...
//FLEXURAL-TORSIONAL AND BUCKLING STRESS
	Fet(){
		...
		return ((Math.pow(Math.PI,2)*this.E*C)/Math.pow(this.Kx*this.Ly,2)+this.G*this.P.J)*(1/(this.P.IX+this.P.IY));
	}//Fet
