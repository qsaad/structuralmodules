...
export default class CapacityW extends Steel {
    constructor({ method, Fy, shape, Lu, Lx, Ly,Kx = 1, Ky = 1, Cb = 1}) {
      super({ method, Fy })
      this.W = DataW.find(item => item.Shape == shape)
      this.c = 1
    ...
    flexureParams(){
      return[
        {name: "Web", value: this.FlangeFlexure(), decimal:0, unit: ""},
        {name: "Flange", value: this.WebFlexure(), decimal:0, unit: ""},
        {name: "L<sub>p</sub>", value: this.Lp()/12, decimal:2, unit: "ft"},
        {name: "L<sub>r</sub>", value: this.Lr()/12, decimal:2, unit: "ft"},
        {name: "bracing", value: this.bracedLength(), decimal:0, unit: ""},
        {name: "c", value: this.c, decimal:2, unit: ""},
        {name: "C<sub>b</sub>", value: this.Cb, decimal:2, unit: ""},
        {name: "S<sub>X</sub>", value: this.W.SX, decimal:2, unit: "in<sup>3</sup>"},
        {name: "H<sub>O</sub>", value: this.W.HO, decimal:2, unit: ""},
        {name: "J", value: this.W.J, decimal:2, unit: "in<sup>4</sup>"},
        {name: "Z<sub>X</sub>", value: this.W.ZX, decimal:2, unit: "in<sup>3</sup>"},
        {name: "M<sub>px</sub>", value: this.Mpx()/12, decimal:2, unit: "k-ft"},
        {name: "F<sub>cr</sub>", value: this.Fcr(), decimal:2, unit: "psi"},
        {name: "M<sub>ltb</sub>", value: this.Mltb()/12, decimal:2, unit: "k-ft"},
        {name: "M<sub>flb</sub>", value: this.Mflb()/12, decimal:2, unit: "k-ft"},
        {name: "Z<sub>Y</sub>", value: this.W.ZY, decimal:2, unit: "in<sup>3</sup>"},
        {name: "M<sub>py</sub>", value: this.Mpy()/12, decimal:2, unit: "k-ft"},
        {name: "F<sub>cry</sub>", value: this.Fcry(), decimal:2, unit: "psi"},
        {name: "M<sub>flby</sub>", value: this.Mflby()/12, decimal:2, unit: "k-ft"},
        {name: "&phi;", value: this.phiF(), decimal:2, unit: ""},
      ]
      // return{
